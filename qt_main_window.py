...
class MidiMainWindow(QMainWindow):
    ...
    def _build_player_section(self) -> None:
        ...
        self.transpose_label = DoubleClickLabel()
        ...
        self.transpose_label.doubleClicked.connect(lambda: self._set_option("transpose_semitones", 0))
        self.octave_label = DoubleClickLabel()
        ...
        self.octave_label.doubleClicked.connect(lambda: self._set_option("octave_shift", 0))
